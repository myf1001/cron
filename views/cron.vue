                ...
                <div class="tabBody">
                    ...
                    <el-row>
                        <el-radio v-model="year.cronEvery" label="2">{{text.Year.interval[0]}}
                            ...
                            <el-input-number size="small" v-model="year.incrementStart" :min="nowYear" :max="nowYear + 100"></el-input-number>
                        </el-radio>
                    </el-row>
                    <el-row>
                        <el-radio class="long" v-model="year.cronEvery" label="3">{{text.Year.specific}}
                            <el-select size="small" filterable multiple v-model="year.specificSpecific">
                                <el-option v-for="(val,index) in 100" :key="index" :label="nowYear+val-1" :value="nowYear+val-1"></el-option>
                            </el-select>
                        </el-radio>
                    </el-row>
                    <el-row>
                        <el-radio v-model="year.cronEvery" label="4">{{text.Year.cycle[0]}}
                            <el-input-number size="small" v-model="year.rangeStart"  :min="nowYear" :max="nowYear+100"></el-input-number>
                            {{text.Year.cycle[1]}}
                            <el-input-number size="small" v-model="year.rangeEnd"  :min="nowYear" :max="nowYear+100"></el-input-number>
                        </el-radio>
                    </el-row>
                </div>
            </el-tab-pane>
...
<script>
    ...
    computed: {
        ...
        daysText:{
            get(){
                ...
                switch (cronEvery.toString()) {
                    ...
                    case "3":
                    days =
                        this.day.incrementStart + "/" + this.day.incrementIncrement;
                    break;
                    case "5":
        ...
        yearsText:{
            ...
            set(value){
                ...
                if(value.indexOf(',') !== -1 || (value.length > 0 && !Number.isNaN(Number(value)) && Number(value) <= (this.nowYear + 100) && Number(value) >= this.nowYear)) {
    ...
    methods: {
        ...
        close(){
            this.$emit('close');
            this.setValue(this.formData.cron)
